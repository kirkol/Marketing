...
public class Login {
	...
	public Login() {
		initialize();
		connection=RCPdatabaseConnection.dbConnector("Marketing0", "1234"); // pierwsze polaczenie z baza jest na user0 (nie ma zadnego konta w programie na tym userze). 
		...
		try {
			...
			if(count==1)
			{
				if(getAdmin()){
					...
					Menu mojeMenu = new Menu(connection);
